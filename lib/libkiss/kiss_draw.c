...
kiss_image	bt_arrup, bt_arrdown, bt_arrleft, bt_arright, bt_obj, bt_cam,
				bt_zoomin, bt_zoomout,
			bt_arrup_p, bt_arrdown_p, bt_arrleft_p, bt_arright_p, bt_obj_p,
				bt_cam_p, bt_zoomin_p, bt_zoomout_p;
...
SDL_Color color_bg =		{15, 65, 40, 255};
SDL_Color color_frame =		{30, 110, 80, 255};
SDL_Color color_frame_a = 	{140, 150, 80, 255};
SDL_Color color_font = 		{60, 220, 160, 255};
SDL_Color color_font_a = 	{120, 220, 80, 255};
SDL_Color color_hl = 		{30, 110, 80, 255};
...
SDL_Renderer* kiss_init(char* title, kiss_array *a, int w, int h)
{
	...
	r += kiss_font_new(&kiss_textfont,
							"fonts/kiss_font.ttf", a, kiss_textfont_size);
	r += kiss_font_new(&kiss_buttonfont,
							"fonts/kiss_font.ttf", a, kiss_buttonfont_size);
	init_kiss_imgs(&r, a, renderer);
	if (r) {
		kiss_clean(a);
		return NULL;
	}
