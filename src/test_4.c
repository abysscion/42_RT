...
/*   Updated: 2019/02/23 15:10:17 by emayert          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	void	abuse_norme_0(t_env *e, int *i)
{
	...
	2.8, 230, 230, 230, 5, T_SPHERE}, ++*i, e);
	cr_obj((t_bs){6, -7, 20, 0, 0, 0,
	2.8, 230, 230, 230, 5, T_SPHERE}, ++*i, e);
	cr_obj((t_bs){-6, 7, 20, 0, 0, 0,
	2.8, 230, 230, 230, 5, T_SPHERE}, ++*i, e);
...
static	void	abuse_norme_1(t_env *e, int *i)
{
	...
	1, 180, 0, 0, 100, T_SPHERE}, ++*i, e);
	cr_obj((t_bs){0, 0, 55, 0, 0, -1,
	0, 80, 140, 250, 0, T_PLANE}, ++*i, e);
	cr_obj((t_bs){0, 7, 0, 0, -1, 0,
	0, 150, 150, 150, 0, T_PLANE}, ++*i, e);
	cr_obj((t_bs){0, -7, 0, 0, 1, 0,
	0, 150, 150, 150, 0, T_PLANE}, ++*i, e);
	cr_obj((t_bs){-6, 0, 20, 0, -1, 0,
	1.5, 230, 230, 230, 10, T_CYLINDER}, ++*i, e);
	cr_obj((t_bs){6, 0, 20, 0, -1, 0,
	1.5, 230, 230, 230, 10, T_CYLINDER}, ++*i, e);
