...
/*   Updated: 2019/03/07 16:28:00 by cschuste         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			create_scene_3(t_env *e)
{
	...
	cr_obj((t_bs){0, 2.2, 19, 0, 0, 0, 2.2, 180, 0, 0, 6, 0.5, 0, T_SPHERE}, ++i, e);
	cr_obj((t_bs){0, 0, 40, 0, 0, -1, 0, 80, 40, 250, 0, 0, 0, T_PLANE}, ++i, e);
	cr_obj((t_bs){0, 4, 0, 0, -1, 0, 0, 0, 150, 60, 0, 0, 0.5, T_PLANE}, ++i, e);
	create_light(e);
}
