...
/*   Updated: 2019/03/07 10:58:31 by cschuste         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	void	abuse_norme_0(t_env *e, int *i)
{
	...
	2.8, 230, 230, 230, 5, 0, T_SPHERE}, ++*i, e);
	cr_obj((t_bs){6, -7, 20, 0, 0, 0,
	2.8, 230, 230, 230, 5, 0, T_SPHERE}, ++*i, e);
	cr_obj((t_bs){-6, 7, 20, 0, 0, 0,
	2.8, 230, 230, 230, 5, 0, T_SPHERE}, ++*i, e);
...
static	void	abuse_norme_1(t_env *e, int *i)
{
	...
	1, 180, 0, 0, 100, 1, T_SPHERE}, ++*i, e);
	cr_obj((t_bs){0, 0, 55, 0, 0, -1,
	0, 80, 140, 250, 0, 0, T_PLANE}, ++*i, e);
	cr_obj((t_bs){0, 7, 0, 0, -1, 0,
	0, 150, 150, 150, 0, 0, T_PLANE}, ++*i, e);
	cr_obj((t_bs){0, -7, 0, 0, 1, 0,
	0, 150, 150, 150, 0, 0, T_PLANE}, ++*i, e);
	cr_obj((t_bs){-6, 0, 20, 0, -1, 0,
	1.5, 230, 230, 230, 10, 0, T_CYLINDER}, ++*i, e);
	cr_obj((t_bs){6, 0, 20, 0, -1, 0,
	1.5, 230, 230, 230, 10, 0, T_CYLINDER}, ++*i, e);
