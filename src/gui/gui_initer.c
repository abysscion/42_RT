...
/*   Updated: 2019/03/08 16:21:27 by eloren-l         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_im	*new_image(char *path, t_env *e)
{
	...
	im->ptimg = mlx_xpm_file_to_image(e->mlx.mlx_ptr, im->path, &im->len, &im->wid);
	return (im);
}
...
{
	e->gui->pt_back_img = mlx_new_image(e->mlx.mlx_ptr,
